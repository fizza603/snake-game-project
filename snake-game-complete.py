...
class Snake(Tk):
    ...
    def initialSetup(self):
        ...
        #snake body create 
        self.snake=self.base.create_rectangle(1,1,18,18,fill="green")
        #score
        self.score=0
    ...
    def check_snake_coords(self):
        ...
        if i<=0 or j<=0 or ii>=500 or jj>=500:
            ...
            self.y=0
            #gameover
            self.base.create_text(240,240,text="GAME OVER",font=('arial',40,'bold'),fill='red')
            self.gameStatus=0
        return
    #movement of snake
    def move_snake(self):
        ...
        self.base.create_line(tuple(self.bodycoords),tag='snakebody',width=16,fill="green")
        return
    #snake food    
    def food(self):
        if self.target==None:
